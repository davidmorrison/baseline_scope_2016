...
pixel layers (blue).  While the mass resolution for the 1S state is
similar, the poor efficiency of the VTX pixels causes a very large
...
\end{figure}
Both are with a four MAPS outer layer (as a
reference). The mass resolution is very comparable.  The VTX pixel
efficiencies are 89\% for layer 0 and 76\% for layer 1 and are based
on measurements of their performance.
